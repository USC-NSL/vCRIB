 ...
 */
public class ThreadMinTrafficSwitchReplicateSelectionCluster extends SwitchReplicateSelectionCluster {
    ...
    public ThreadMinTrafficSwitchReplicateSelectionCluster(int threadNum,Map<Partition, Map<Rule, List<Flow>>> ruleFlowMap) {
    ...
    public void init( Topology topology,
        ...
        super.init( topology, initialSetOfSwitches);
        switches = new ArrayList<Switch>(initialSetOfSwitches);
    ...
    @Override
    public List<Switch> sortSwitches(Collection<Switch> availableToChoose, Cluster cluster, Collection<Switch> sources,
        ...
        for (int j = 0; j < threadNum; j++) {
            threads[j] = new ProcessThread(itr, cluster,
...
//            Long traffic = switchTrafficMap.get(next);
//            /*if (traffic >= previousTraffic) {
//                if (traffic > previousTraffic) {
//                    System.out.println("traffic increased after replication!!!!");
//
//
//                    long traffic2 = 0;
...
//        }
    ...
    static class ProcessThread extends Thread {
        ...
        public ProcessThread(Iterator<Switch> itr, Cluster cluster,
